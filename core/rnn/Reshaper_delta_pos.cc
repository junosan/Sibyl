...
Reshaper_delta_pos::Reshaper_delta_pos(unsigned long maxGTck_) : Reshaper(maxGTck_)
{
    inputDim  = 45;
}

void Reshaper_delta_pos::State2Vec(FLOAT *vec, const ItemState &state)
{
...
void Reshaper_delta_pos::Reward2Vec(FLOAT *vec, const Reward &reward, CSTR &code)
{
